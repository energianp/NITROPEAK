...
function cargarDistribuidores() {
    db.collection('ubicaciones').get().then(snap => {
        ...
        const logos = {
            'Súper Selectos': 'https://lh5.googleusercontent.com/proxy/AMFlJ-jPT6vttXgQQ0MtfyHFBzxBuf5d-rwgdYiYw-65Un4ErF6zqGd8F2UEnBmzacSLpM_48ErpHqDT',
            'Walmart': 'https://images.seeklogo.com/logo-png/15/2/walmart-logo-png_seeklogo-151324.png',
            'Pricesmart': 'https://images.seeklogo.com/logo-png/48/2/pricesmart-logo-png_seeklogo-488763.png',
            'Maxi Despensa': 'https://logo.clearbit.com/maxidespensa.com',
            'La Despensa de Don Juan': 'https://cdn.remitly.com/images/v1/img/la_curacao_copy_mon_nov_20_2017.4dRBUuL92ctbVjfi4y2Yc8.png',
            'Farmacia San Nicolás': 'https://iconape.com/wp-content/png_logo_vector/farmacia-san-nicolas-logo.png',
            ...
            'Tienda 24/7': '',
            'Farmacia Vicentina': '',
            'Farmacia La Moderna': 'https://i.pinimg.com/736x/ef/cc/01/efcc01530e27ebf6fd277d52e80065fd.jpg',
            'Farmacia El Rosario': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoMrF43eOQXr4qSip0Vhytl4b9FIZHqJ60VA&s',
            'Tda. El Mercadito': '',
            'Tda. Nahomy': '',
            'Tda. Luz': ''
        };
